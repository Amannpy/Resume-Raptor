"""
Resume Raptor - Main Application
"""
import time
...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/Amann/Resume-Raptor' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/amann2611/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Amann</b>
                </a>
            </p>
     ...
     "124852522.jpeg")
        ...
        st.markdown("""
            <div class="hero-section">
                <h1 class="hero-title">About Resume Raptor</h1>
        ...
        st.markdown(f"""
            <div class="profile-section">
                <img src="{image_base64 if image_base64 else 'https://avatars.githubusercontent.com/Amannpy'}"
                     alt="Het Patel"
                     class="profile-image"
                     onerror="this.onerror=null; this.src='https://avatars.githubusercontent.com/Amannpy';">
                <h2 class="profile-name">Aman</h2>
                <p class="profile-title">Python Developer & AI/ML Enthusiast</p>
                <div class="social-links">
                    <a href="https://github.com/Amannpy" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/amann2611/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="mailto:aman.kumar.cse2611@gmail.com" class="social-link" target="_blank">
                        <i class="fas fa-envelope"></i>
                    </a>
                </div>
                <p class="bio-text">
                    Hello! I'm a passionate Full Stack Developer with expertise in AI and Machine Learning.
                    I created Resume Raptor to revolutionize how job seekers approach their career journey.
        ...
        st.markdown("""
            <div class="vision-section">
                ...
                <p class="vision-text">
                    "Resume Raptor represents my vision of democratizing career advancement through technology.
    ...
    def show_repo_notification(self):
        ...
        <ul style="margin-top: 0; padding-left: 20px;">
            <li><a href="https://github.com/Amannpy/AI-Therapist" target="_blank" style="color: #4CAF50;">AI Therapist</a></li>
        </ul>
